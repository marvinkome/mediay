...
import { Button, chakra, Container, Heading, Stack, Text, Image, Box, Grid } from "@chakra-ui/react";
  ...
  return (
    <chakra.div color="#fff" fontWeight="500">
      ...
      <chakra.nav w="100%" pos="fixed" top="0" left="0" right="0" zIndex="2">
        <Stack py={{ base: "12px", md: "24px" }} px={{ base: "16px", md: "48px" }} direction="row" justify="space-between" align="center">
      ...
      <chakra.section>
        <Container maxW="100%" p="0" borderBottom="4px solid rgba(255, 255, 255, 0.04)">
          <Stack justify="center" align="center" spacing={{ base: "-2rem", md: "-6rem" }} py={{ base: "2rem", md: "1rem" }}>
            ...
            <Heading color="#FA5B17" fontSize={{ base: "92px", md: "260px" }} fontWeight="700" lineHeight={{ base: "124px", md: "351px" }}>
              Mediay
            </Heading>
          </Stack>
      ...
      <chakra.footer bgColor="#7026EA">
        <Container maxW="100%" p="0" bgImage="url(/images/bg_footer.png)" bgRepeat="no-repeat" bgSize="100%" bgPos="center">
          <Grid overflow="hidden" pb={{ base: "8", md: "8" }} templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(3, 1fr)" }}>
            <Stack justify="space-between" h="100%" align="left" gridColumn={{ base: "1 / 1", md: "1 / 3" }}>
